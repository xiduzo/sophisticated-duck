    ...
    <>
      ...
      <main className="flex min-h-screen">
        ...
        <article className="flex grow justify-center text-white">
          <div
            className="flex h-screen grow flex-col divide-y divide-stone-700/60 overflow-y-scroll pb-52"
            id="conversation"
            ref={conversationRef}
          >
          ...
          <div className="absolute bottom-0 left-0 h-28 w-full bg-gradient-to-t from-stone-900 to-[#0c0a0900]"></div>
          <section className="absolute bottom-8 m-auto w-full max-w-3xl">
            <ChatForm
